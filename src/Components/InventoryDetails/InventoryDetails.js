...
const InventoryDetails = () => {
  ...
  useEffect(() => {
    fetch(`https://intense-meadow-16226.herokuapp.com/products/${inventoryId}`)
  ...
  const handleDelivery = () => {
    fetch(
      `https://intense-meadow-16226.herokuapp.com/products/${inventoryId}`,
      {
        method: "PUT",
        body: JSON.stringify({
      ...
      <div className="row">
        <div className="container col-12 col-md-6 col-lg-4 text-center">
          <Card style={{ width: "18rem" }}>
            ...
            <Card.Body>
              ...
              <Button variant="warning" onClick={handleDelivery}>
                Delivered
              </Button>
            </Card.Body>
        ...
        <div className="text-center mx-5">
          <button
            ...
            className="btn btn-secondary w-50 text-center  mt-5"
          >
            Manage Inventory
          </button>
        </div>
